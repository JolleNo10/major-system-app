...
The calibration follow-up verified the authored data with the focused World Countries map suite (13 files, 169 tests), including safe-zone regressions for Poland, Serbia, Romania, Moldova, Ukraine, and Belarus and representative Oceania target-composition guards. It did not include browser/manual inspection because no already-running browser surface was available.
