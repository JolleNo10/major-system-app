...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-30 (commit 0686309). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 8.61/10 avg, hotspot health 7.47/10 (stable), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.61/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `CONTEXT.md` — churn risk — impact −2.4
- `src/app/settings/SettingsOverlay.tsx` — change entropy — impact −2.3
- `src/features/world-countries/index.ts` — untested hotspot — impact −2.0
- `src/features/world-countries/learning/subregionLearningStore.ts` — churn risk — impact −2.0
- `src/features/pi/recite/PiReciteTab.tsx` — churn risk — impact −2.0
