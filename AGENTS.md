...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-05 (commit 8675c51). Confidence: 99%.
...
- `src/features/world-countries/maps/GeographyOverviewMap.test.tsx` — 9 bug fixes, last fix 4 days ago (bug magnet); 30 commits/90d
- `src/features/world-countries/maps/SvgMapController.test.ts` — 7 bug fixes, last fix 4 days ago (bug magnet); 22 commits/90d
- `src/features/world-countries/maps/GeographyOverviewMap.tsx` — 7 bug fixes, last fix 4 days ago (bug magnet); 25 commits/90d
- `src/features/world-countries/practice/NeighboursQuizSession.test.tsx` — 5 bug fixes, last fix 4 days ago (bug magnet); 9 commits/90d
- `src/features/world-countries/practice/NeighboursQuizSession.tsx` — 5 bug fixes, last fix 4 days ago (bug magnet); 9 commits/90d

### Code health
Three co-equal signals: defect risk 8.01/10 avg, hotspot health 6.42/10 (stable), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.57/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `docs/changes/0010-world-countries-map-centered-interaction-qol.md` — untested hotspot — impact −2.0
