...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 212c8b1). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 7.72/10 avg, hotspot health 6.81/10 (improving), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.32/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/features/world-countries/recite/ReciteSessionView.tsx` — untested hotspot — impact −2.0
...
- `src/features/major-system/WordNumberDrill.tsx` — untested hotspot — impact −2.0
