...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit e55be40). Confidence: 99%.
...
- `src/features/world-countries/maps/GeographyOverviewMap.test.tsx` — 13 bug fixes, last fix 2 days ago (bug magnet); 37 commits/90d
- `src/features/world-countries/maps/SvgMapController.test.ts` — 11 bug fixes, last fix 2 days ago (bug magnet); 28 commits/90d
- `src/features/world-countries/maps/SvgMapController.ts` — 10 bug fixes, last fix 2 days ago (bug magnet); 31 commits/90d
- `src/features/world-countries/maps/GeographyOverviewMap.tsx` — 8 bug fixes, last fix 2 days ago (bug magnet); 29 commits/90d
- `src/features/world-countries/drill/PageLayoutDrillSetup.test.tsx` — 4 bug fixes, last fix yesterday (bug magnet); 20 commits/90d

### Code health
Three co-equal signals: defect risk 7.8/10 avg, hotspot health 6.87/10 (stable), worst `src/features/world-countries/today/WorldCountriesToday.tsx` at 2.15/10 · maintainability 9.32/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/features/pi/recite/PiReciteTab.tsx` — churn risk — impact −1.8
- `src/features/world-countries/today/TodayRails.tsx` — churn risk — impact −1.7
- `src/features/world-countries/learning/CountryLearningMap.tsx` — change entropy — impact −1.7
- `src/features/world-countries/ui/MapSurface.test.tsx` — prior defect — impact −1.5
- `src/features/world-countries/WorldCountries.tsx` — churn risk — impact −1.4
