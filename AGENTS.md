...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-30 (commit ed4b6fc). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 8.6/10 avg, hotspot health 7.46/10 (stable), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.61/10 · performance risk 11 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
