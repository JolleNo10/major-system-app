...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-01 (commit 446c100). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 8.61/10 avg, hotspot health 7.77/10 (stable), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.59/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
