...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 8dfc416). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 7.72/10 avg, hotspot health 6.8/10 (stable), worst `src/features/world-countries/maps/SvgMapController.ts` at 2.35/10 · maintainability 9.32/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
