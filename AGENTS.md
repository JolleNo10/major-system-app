...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-12 (commit e1e115f). Confidence: 99%.
...
- `src/features/world-countries/maps/SvgMapController.test.ts` — 15 bug fixes, last fix today (bug magnet); 32 commits/90d
- `src/features/world-countries/maps/GeographyOverviewMap.test.tsx` — 14 bug fixes, last fix yesterday (bug magnet); 39 commits/90d
- `src/features/world-countries/maps/SvgMapController.ts` — 14 bug fixes, last fix today (bug magnet); 35 commits/90d
- `src/features/world-countries/today/WorldCountriesToday.tsx` — 8 bug fixes, last fix yesterday (bug magnet); 33 commits/90d
- `src/features/world-countries/today/GuidedHomeRails.tsx` — 5 bug fixes, last fix yesterday (bug magnet); 22 commits/90d

### Code health
Three co-equal signals: code health 7.04/10 avg (Good), hotspot health 5.46/10 (declining), worst `src/features/world-countries/maps/svgTaskAssistance.ts` at 2.2/10 · maintainability 8.69/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
