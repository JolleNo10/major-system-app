...
export function Overlay({ onClose, ariaLabel, header, maxWidth = 'max-w-2xl', bodyClassName = '', presentation = 'modal', dismissible = true, children }: Props) {
  const ref = useRef<HTMLDivElement>(null)
  useOverlay(ref, onClose, dismissible)
