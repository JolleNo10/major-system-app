...
export function PiMemoTab({ answerMode, maxPiPairs }: Props) {
  ...
  const { story, loading: storyLoading } = usePiStory(selectedSeg, storyRefresh)
  ...
  useRails(
    ...
    [phase, nextSeg, statuses.length, studySegment, story, storyLoading, sequence, words, storyEditing, saveStory, storyFlash, copyWords, copied],
  )
