...
function FixedPracticePanel({ mode, interaction, onInteractionChange, scopeSummary, canStart, noMatching, disabledButtonLabel, onStart }: { mode: WorldCountriesPracticeMode; interaction?: WorldCountriesPracticeInteraction; onInteractionChange?: (interaction: WorldCountriesPracticeInteraction) => void; scopeSummary?: string; canStart: boolean; noMatching: boolean; disabledButtonLabel: string; onStart: () => void }) {
