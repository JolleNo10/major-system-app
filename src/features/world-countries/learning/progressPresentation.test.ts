...
describe('World Countries progress presentation semantics', () => {
  it('uses core Country state by default and atomic state for a skill view', () => {
    const itemProgress = deriveWorldCountriesRecallProgress({
      ...
      { itemId: recallTargetIdFor('NO', 'country-to-capital'), at: 4, ok: true, ms: 500, evidenceKind: 'recall', attemptType: 'review', localDate: '2026-08-10' },
      { itemId: recallTargetIdFor('NO', 'country-to-capital'), at: 5, ok: true, ms: 500, evidenceKind: 'recall', attemptType: 'review', localDate: '2026-08-11' },
      { itemId: recallTargetIdFor('NO', 'country-to-capital'), at: 6, ok: true, ms: 500, evidenceKind: 'recall', attemptType: 'review', localDate: '2026-08-12' },
      { itemId: recallTargetIdFor('NO', 'capital-to-country'), at: 7, ok: false, ms: 500, evidenceKind: 'recognition', attemptType: 'review', localDate: '2026-08-13' },
    ])
