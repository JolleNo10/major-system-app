...
export const COUNTRY_RECORDS: CountryRecordInput[] = [
  ...
  { id: 'GB', country: "United Kingdom", capital: "London", continent: "Europe", subregion: "Northern Europe", countryAliases: ["UK", "Britain", "Great Britain"] },
  ...
  { id: 'UA', country: "Ukraine", capital: "Kyiv", continent: "Europe", subregion: "Eastern Europe", capitalAliases: ["Kiev"] },
  ...
  { id: 'BA', country: "Bosnia and Herzegovina", capital: "Sarajevo", continent: "Europe", subregion: "Balkans", countryAliases: ["Bosnia"] },
  ...
  { id: 'XK', country: "Kosovo", capital: "Pristina", continent: "Europe", subregion: "Balkans", capitalAliases: ["Prishtina"] },
  { id: 'MK', country: "North Macedonia", capital: "Skopje", continent: "Europe", subregion: "Balkans", countryAliases: ["Macedonia"] },
  ...
  { id: 'CZ', country: "Czechia", capital: "Prague", continent: "Europe", subregion: "Central Europe", countryAliases: ["Czech Republic"] },
  ...
  { id: 'SM', country: "San Marino", capital: "San Marino", continent: "Europe", subregion: "Southern Europe" },
  { id: 'VA', country: "Vatican City", capital: "Vatican City", continent: "Europe", subregion: "Southern Europe", countryAliases: ["Vatican"] },
  ...
  { id: 'TR', country: "Türkiye", capital: "Ankara", continent: "Asia", subregion: "West Asia", countryAliases: ["Turkey"] },
  ...
  { id: 'AE', country: "United Arab Emirates", capital: "Abu Dhabi", continent: "Asia", subregion: "West Asia", countryAliases: ["UAE"] },
  ...
  { id: 'AM', country: "Armenia", capital: "Yerevan", continent: "Asia", subregion: "Caucasus", capitalAliases: ["Erevan"] },
  ...
  { id: 'MN', country: "Mongolia", capital: "Ulaanbaatar", continent: "Asia", subregion: "East Asia", capitalAliases: ["Ulan Bator", "Ulan Baatar"] },
  { id: 'CN', country: "China", capital: "Beijing", continent: "Asia", subregion: "East Asia" },
  { id: 'KP', country: "North Korea", capital: "Pyongyang", continent: "Asia", subregion: "East Asia", countryAliases: ["DPRK", "Democratic People's Republic of Korea"] },
  { id: 'KR', country: "South Korea", capital: "Seoul", continent: "Asia", subregion: "East Asia", countryAliases: ["ROK", "Republic of Korea"] },
  ...
  { id: 'LK', country: "Sri Lanka", capital: "Sri Jayawardenepura Kotte", continent: "Asia", subregion: "South Asia", capitalAliases: ["Kotte", "Jayawardenepura Kotte", "Sri Jayawardenepura"] },
  { id: 'MV', country: "Maldives", capital: "Malé", continent: "Asia", subregion: "South Asia" },
  { id: 'MM', country: "Myanmar", capital: "Naypyidaw", continent: "Asia", subregion: "Southeast Asia", countryAliases: ["Burma"], capitalAliases: ["Nay Pyi Taw", "Naypyitaw"] },
  { id: 'LA', country: "Laos", capital: "Vientiane", continent: "Asia", subregion: "Southeast Asia", countryAliases: ["Lao PDR", "Lao People's Democratic Republic"] },
  ...
  { id: 'BN', country: "Brunei", capital: "Bandar Seri Begawan", continent: "Asia", subregion: "Southeast Asia", countryAliases: ["Brunei Darussalam"], capitalAliases: ["BSB"] },
  ...
  { id: 'TL', country: "Timor-Leste", capital: "Dili", continent: "Asia", subregion: "Southeast Asia", countryAliases: ["East Timor"] },
  ...
  { id: 'FM', country: "Micronesia", capital: "Palikir", continent: "Oceania", subregion: "Micronesia", countryAliases: ["FSM", "Federated States of Micronesia"] },
  ...
  { id: 'KI', country: "Kiribati", capital: "South Tarawa", continent: "Oceania", subregion: "Micronesia", capitalAliases: ["Tarawa"] },
  { id: 'PG', country: "Papua New Guinea", capital: "Port Moresby", continent: "Oceania", subregion: "Melanesia", countryAliases: ["PNG"] },
  ...
  { id: 'CI', country: "Côte d'Ivoire", capital: "Yamoussoukro", continent: "Africa", subregion: "West Africa", countryAliases: ["Ivory Coast"] },
  ...
  { id: 'GM', country: "Gambia", capital: "Banjul", continent: "Africa", subregion: "West Africa", countryAliases: ["The Gambia"] },
  { id: 'CV', country: "Cabo Verde", capital: "Praia", continent: "Africa", subregion: "West Africa", countryAliases: ["Cape Verde"] },
  ...
  { id: 'ST', country: "São Tomé and Príncipe", capital: "São Tomé", continent: "Africa", subregion: "Central Africa", countryAliases: ["Sao Tome"] },
  ...
  { id: 'SZ', country: "Eswatini", capital: "Mbabane", continent: "Africa", subregion: "Southern Africa", countryAliases: ["Swaziland"] },
  ...
  { id: 'US', country: "United States", capital: "Washington, D.C.", continent: "North America", subregion: "Northern America", countryAliases: ["USA", "US", "America", "United States of America"], capitalAliases: ["Washington", "DC"] },
  ...
  { id: 'BS', country: "Bahamas", capital: "Nassau", continent: "North America", subregion: "Caribbean", countryAliases: ["The Bahamas"] },
  ...
  { id: 'KN', country: "Saint Kitts and Nevis", capital: "Basseterre", continent: "North America", subregion: "Caribbean", countryAliases: ["St Kitts and Nevis", "St Kitts"] },
  { id: 'AG', country: "Antigua and Barbuda", capital: "Saint John's", continent: "North America", subregion: "Caribbean", capitalAliases: ["St Johns", "St John's"] },
  ...
  { id: 'VC', country: "Saint Vincent and the Grenadines", capital: "Kingstown", continent: "North America", subregion: "Caribbean", countryAliases: ["St Vincent and the Grenadines", "St Vincent"] },
  { id: 'GD', country: "Grenada", capital: "Saint George's", continent: "North America", subregion: "Caribbean", capitalAliases: ["St Georges", "St George's"] },
