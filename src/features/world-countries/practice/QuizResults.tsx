...
export function QuizResults({ run, answers, onRetryMissed, onNewQuiz, onChangeSetup }: {
  ...
  return (
    <section className="mx-auto w-full max-w-3xl space-y-6 py-8" aria-labelledby="world-countries-recall-quiz-results-heading">
      <div className="space-y-2 text-center">
        <p className="text-xs font-semibold uppercase tracking-wider text-green-400">Quiz complete</p>
        <h1 id="world-countries-recall-quiz-results-heading" className="text-3xl font-black text-zinc-100">{summary.correct} / {run.countryIds.length}</h1>
