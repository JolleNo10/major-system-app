      ...
      {complete ? (
        ...
        <>
          ...
          <form
            ...
            data-spelling-answer-row
            className="mt-[14px] grid grid-cols-[minmax(0,1fr)_auto] gap-[14px]"
          >
            <input
              ref={inputRef}
              type="text"
              ...
              className="min-w-0 rounded-[10px] border border-amber-300/20 bg-black/20 px-3 py-2.5 text-center text-base font-medium text-amber-50 outline-none transition-colors placeholder:text-zinc-600 focus:border-amber-300/50 focus:ring-1 focus:ring-amber-300/30"
            />
            <button
              type="submit"
