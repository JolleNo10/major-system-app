import type { AllStats, Direction, AnswerMode } from '@/core/types'
import {
  loadStore, saveStore, getItem, setItem, type ItemRecord,
} from '@/core/scoring/itemStore'
import { OUTLIER_MS, MAX_LATENCIES } from '@/core/scoring/scoring'
import { addAttempt } from '@/core/scoring/attemptStore'
import { gradeAnswer, applySm2 } from '@/core/scoring/sm2'
import { adjustLatency, recordTypingSpeed } from '@/core/scoring/typingSpeed'
